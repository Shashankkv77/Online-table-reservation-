...
<html lang="en">
  ...
  <head>
    ...
    <title>kv's Cafe - Restaurant </title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">kvscafe@gmail.com</a><br><a href="#">kvscafe@company.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 <!------ Php section--------------------->
    ...
    <?php
         $con = mysqli_connect('localhost', 'root', '', 'kvcafe');
         if(!$con){
    ...
    ?>
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                              <input name="email" type="text" id="email" pattern="[^ @]*@[^ @]*" placeholder="Your Email Address" required="" autocomplete="off"/>
                            </fieldset>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                              <fieldset>
                                <input name="phone" type="text" id="phone" placeholder="Phone Number*" required="" autocomplete="off"/>
                              </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="seat" id="number-guests" autocomplete="off">
